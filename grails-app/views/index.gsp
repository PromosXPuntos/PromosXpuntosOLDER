...
<section class="wrapper style1" style="padding: 0; margin: 0;" align="center">
	<h2>Encuentranos</h2>
	<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d16491.39356475207!2d-74.08865031089259!3d4.654165704834756!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses-419!2sco!4v1446650936869" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
</section>
				...
				<div class="row uniform 50%">
					...
					<g:if test="${!hasErrors(field: 'birthday','error')}">
						<div class="4u 12u$(xsmall)">
							<g:datePicker name="birthday" id="birthday" precision="day" class="form-control" value="${new Date()}"  noSelection="['':'Selecciona']"/>
						</div>
					</g:if>
				</div>
			</div>
